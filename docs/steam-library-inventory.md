# Inventaire Steam Game Note

Inventaire établi à partir des 11 captures Steam reçues le 10 août 2026.
Les intitulés tronqués dans l'interface sont normalisés pendant l'audit par
AppID. `published` signifie que le guide est déjà intégré au site ; `planned`
signifie qu'il doit encore être recherché et rédigé ; `special` couvre les
jeux sans succès Steam mais avec une soluce utile ; `excluded` signifie qu'une
soluce chronologique classique n'apporterait rien.

## Déjà intégrés au site (`published`)
...
Ces jeux sont bien enregistrés pour ne pas être reproposés comme guides
chronologiques classiques :

- Counter-Strike 2, Counter-Strike, Condition Zero, Condition Zero Deleted
  Scenes et Counter-Strike: Source
- Dota 2, Dota Underlords, Element TD, Element TD 2
- Apex Legends, ARC Raiders, Battlerite, Battlerite Public Test, Brawlhalla,
  Black Squad, Conqueror's Blade, Deadlock, Deceit, Fall Guys, Infinite Crisis,
  Monday Night Combat, Natural Selection 2, PUBG, Ring of Elysium, SMITE,
  SMITE Public Test, SMITE 2, Team Fortress 2, THE FINALS, Warface: Clutch
- Aimlabs, Assetto Corsa, FlatOut, FlatOut 2, FlatOut: Ultimate Carnage,
  Golf With Your Friends, NBA 2K20, Street Fighter si aucun parcours de
  campagne n'est requis, Wreckfest et Zaccaria Pinball
- After The Fall, ARK: Survival Evolved, ARK: Survival Of The Fittest,
  Besiege, Core Keeper, Don't Starve Together, Icarus, Necesse, Oxygen Not
  Included, Project Zomboid, Rust, Rust Staging Branch, Trailmakers,
  Unturned, Valheim
- Darwin Project, Free to Play, Game Migrated to Another Steam Library,
  Gotham City Impostors et Gotham City Impostors: Free to Play
- Back 4 Blood Beta, Company of Heroes 3: Mission Alpha, Fallout 76 Public
  Test Server, Magicka 2: Spell Balance Beta, PUBG Experimental / Test Server,
  et Wreckfest Throw-A-Santa + Sneak quand l'entrée est seulement un contenu
  de test ou une extension non autonome
- Apex-like ou jeux-service sans route fixe : Once Human, Path of Exile,
  Rec Room, Red Dead Online, The Sims 4, Tribes of Midgard
- Gang Beasts, Garry's Mod, Gorilla Tag, Human Fall Flat, Killing Floor,
  Killing Floor 2, No More Room in Hell, Primal Carnage, Scavengers,
  The Survivalists, Worms Armageddon, Worms Revolution
- The Binding of Isaac: Rebirth et Vampire Survivors si le périmètre reste
  celui d'une roadmap de déblocage plutôt qu'une soluce chronologique

## Règle de traitement

1. Une entrée `planned` passe par l'audit AppID, succès Steam, DLC, online et
   missables avant la rédaction.
2. Une entrée `special` doit annoncer clairement l'absence éventuelle de
   succès Steam au lieu de promettre un faux 100 %.
3. Une entrée `excluded` ne revient dans les guides que si une demande
   spécifique apporte un périmètre différent, par exemple une campagne
   précise ou une roadmap de succès séparée.
4. Aucun guide ne révèle une mort, une identité, une trahison, une fin, un
   twist ou une conséquence narrative.
